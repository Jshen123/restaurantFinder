module.exports = function queriesAndFunctions(db) {
    return {
      ...
      addRestaurant: (name, price, address, description, tags, done) => {
        ...
        db.insert({name:name, price:price, address:address, type:"Test restaurant", description:description, tag:tags})
         .into('restaurants')
         .then(done)
      },
      ...
      updateRestaurant: (restaurantId, name, price, address, description, done) => {

        db.from('restaurants')
         .where({restaurant_id:restaurantId})
         .update({name:name, price:price, address:address, description:description})
         .then(done)
      },
