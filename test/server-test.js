  ...
  describe('Test Redirects', () => {
    ...
    describe('As user', () => {
      ...
      it('should be redirected to /restaurants on successful registration', (done) => {
        ...
        chai.request(server).post('/register').send({username: 'user2', password: 'test'}).end((err, res) => {
          ...
          queries.getUserByName('user2', (value, error) => {
            chai.expect(value[0].should.not.equal('undefined'));
          })
    ...
    describe('As admin', () => {
      ...
      it('Should be redirected to /restaurants on successful login', (done) => {
        ...
        chai.request(server).post('/login').send({username: 'admin', password: 'test'}).end((err, res) => {
          ...
          queries.getUserByName('admin', (value, error) => {
            chai.expect(value[0].should.not.equal('undefined'));
          })
